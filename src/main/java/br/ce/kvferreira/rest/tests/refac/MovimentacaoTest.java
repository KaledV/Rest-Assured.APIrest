...
import br.ce.kvferreira.rest.tests.Movimentacao;
import br.ce.kvferreira.rest.utils.BarrigaUtils;
import br.ce.kvferreira.rest.utils.DateUtils;
...
public class MovimentacaoTest extends BaseTest {
	...
	@Test
	public void deveValidaCamposObrigatoriosDaMovimentacao() {
		 given()
	       .body("{}")
		.when()
		   .post("/transacoes")
	...
	private Movimentacao getMovimentacaoValida() {
		...
		//mov.setUsuario_id();
		mov.setDescricao("Descicao da movimentacao");
